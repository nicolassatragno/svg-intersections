        ...
        if ((index + param_length) < tokens.length) {
            ...
            switch (mode) {
                case "A":
                    ...
                    break;
                case "a":
                    segment = new RelativeArcPath(params, previous);
                    break;
                case "C":
                ...
                case "H":
                    ...
                    break;
                case "h":
                    segment = new RelativeHLineto(params, previous);
                    break;
                case "V":
...
AbsoluteHLineto.prototype.getIntersectionParams = function() {
    return IntersectionParams.newLine(this.previous.getLastPoint(), this.points[0]);
};
...
AbsoluteVLineto.prototype.getIntersectionParams = function() {
    return IntersectionParams.newLine(this.previous.getLastPoint(), this.points[0]);
};
...
function RelativeArcPath(params, previous) {
    if (arguments.length > 0) {
        this.init("a", params, previous);
    }
}

RelativeArcPath.prototype = new RelativePathSegment();
RelativeArcPath.prototype.constructor = RelativeCurveto2;
RelativeArcPath.superclass = RelativePathSegment.prototype;

RelativeArcPath.prototype.init = function(command, params, previous) {
    var point = new Array();
    var y = params.pop();
    var x = params.pop();
    point.push(x, y);

    RelativeArcPath.superclass.init.call(this, command, point, previous);
    this.rx = parseFloat(params.shift());
    this.ry = parseFloat(params.shift());
    this.angle = parseFloat(params.shift());
    this.arcFlag = parseFloat(params.shift());
...
RelativeArcPath.prototype.getIntersectionParams = function() {
    return IntersectionParams.newArc(this.previous.getLastPoint(),
                                     this.points[0],
                                     this.rx,
                                     this.ry,
...
function RelativeHLineto(params, previous) {
    if (arguments.length > 0) {
        this.init("h", params, previous);
    }
}
RelativeHLineto.prototype = new RelativePathSegment();
RelativeHLineto.prototype.constructor = RelativeHLineto;
RelativeHLineto.superclass = RelativeLineto.prototype;

RelativeHLineto.prototype.init = function(command, params, previous) {
    var lastPoint;
    if (previous) lastPoint = previous.getLastPoint();
    else lastPoint = new Point(0, 0);
    var point = new Array();
    point.push(params.pop(), 0);
    RelativeHLineto.superclass.init.call(this, command, point, previous);
};
RelativeHLineto.prototype.getIntersectionParams = function() {
    return IntersectionParams.newLine(this.previous.getLastPoint(), this.points[0]);
};
...
RelativeVLineto.superclass = RelativeLineto.prototype;
...
RelativeVLineto.prototype.init = function(command, params, previous) {
    ...
    var point = new Array();
    point.push(0, params.pop());
    RelativeVLineto.superclass.init.call(this, command, point, previous);
};
RelativeVLineto.prototype.getIntersectionParams = function() {
    return IntersectionParams.newLine(this.previous.getLastPoint(), this.points[0]);
};
